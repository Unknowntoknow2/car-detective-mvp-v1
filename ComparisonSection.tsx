      ...
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-16 space-y-4">
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto">
            See how our Premium service provides the most comprehensive
            valuation data available anywhere—combining CARFAX®, dealer offers,
            and advanced AI.
          </p>
        </div>
              ...
              <table className="w-full">
                <tbody>
                  {features.map((feature, index) => (
                    ...
                    >
                      <td className="p-5 px-6 font-medium text-slate-800 w-1/2">
                        {feature.name}
                      </td>
