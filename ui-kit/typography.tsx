...
export const BodyS: React.FC<BodyProps> = (props) => (
  <Body size="small" {...props} />
);
export const BodyM: React.FC<BodyProps> = (props) => (
  <Body size="medium" {...props} />
);
export const BodyL: React.FC<BodyProps> = (props) => (
  <Body size="large" {...props} />
);
