...
describe("CDCard", () => {
  ...
  it("applies variant classes correctly", () => {
    ...
    expect(screen.getByText("Outline Card").closest("div")).toHaveClass(
...
describe("CDFooter", () => {
  it("renders copyright information", () => {
    render(
      <CDFooter copyright="© 2025 Car Detective. All rights reserved." />,
    );

    expect(screen.getByText("© 2025 Car Detective. All rights reserved."))
      .toBeInTheDocument();
  });
