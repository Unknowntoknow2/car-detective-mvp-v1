...
export function generateDetailedExplanation(data: ExplanationRequest): string {
  ...
  paragraphs.push(
    `Your ${year} ${make} ${model} has a base market value of approximately ${
  ...
  paragraphs.push(
    ...
    }. This valuation reflects current market conditions and the specific details you've provided about your vehicle. It represents a fair market value that could be expected in a private party sale under typical circumstances.`,
  );
