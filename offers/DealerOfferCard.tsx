  ...
  return (
    <Card
      className={`overflow-hidden ${
        isBestOffer ? "border-green-500 shadow-md" : ""
      }`}
    >
      <div className="flex flex-col sm:flex-row">
        <div
          className={`p-6 sm:w-1/3 ${
            isBestOffer ? "bg-green-50" : "bg-slate-50"
          ...
          {offer.message
            ...
            : (
              <div className="mb-4">
                ...
                <p className="text-sm">
                  This dealer has submitted an offer based on your vehicle
                  details.
                </p>
              </div>
            )}
