...
const titleStatusOptions: TitleStatusOption[] = [
  {
    ...
    label: "Clean Title",
    description:
      "Vehicle has never been seriously damaged, salvaged, or branded as a lemon",
  ...
  },
  {
    ...
    label: "Salvage Title",
    description:
      "Vehicle was declared a total loss by an insurance company due to damage",
  ...
  },
  {
    ...
    description:
      "Previously salvaged vehicle that has been repaired and inspected",
...
export function TitleStatusSelector(
  { value, onChange, required = false }: TitleStatusSelectorProps,
) {
  const selectedOption =
    titleStatusOptions.find((option) => option.value === value) ||
    titleStatusOptions[0];
        ...
        <div className="text-sm mt-1">
          ...
          <p
            className={`mt-1 font-medium ${
              value === "Clean" ? "text-green-600" : "text-amber-600"
            }`}
          >
