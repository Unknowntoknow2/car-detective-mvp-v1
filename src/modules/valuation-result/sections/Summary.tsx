        ...
        <div className={styles.summary.container}>
          ...
          >
            <div className="flex items-center mb-1.5">
              <BodyS className="text-neutral-dark mr-1.5">
                Confidence Score
              </BodyS>
              <CDTooltip content="Our system's confidence in the accuracy of this valuation based on available data">
          ...
          >
            <div className="flex items-center mb-1.5">
              ...
              <CDTooltip content="The estimated range your vehicle could sell for in the current market">
                <Info className="h-3.5 w-3.5 text-neutral-dark" />
              </CDTooltip>
            </div>
          ...
          >
            <div className="flex items-center mb-1.5">
              ...
              <CDTooltip content="Current market direction for vehicles matching this make, model, and year">
                <Info className="h-3.5 w-3.5 text-neutral-dark" />
              </CDTooltip>
            </div>
