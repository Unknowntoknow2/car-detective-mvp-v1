        ...
        <div className="bg-white p-8 rounded-lg shadow-sm">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 space-y-1">
              ...
              <li>
                Vehicle information (VIN, license plate, make, model, year)
              </li>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 space-y-1">
              ...
              <li>
                Analytics cookies: These help us understand how visitors
                interact with our site
              </li>
              <li>
                Marketing cookies: These track your online activity to help
                deliver relevant advertising
              </li>
            </ul>
            <p className="mt-4">
              You can manage your cookie preferences through our Cookie Consent
              Banner or by clearing cookies in your browser settings.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              contact us at privacy@carvaluationapp.com
            </p>
          </section>
        </div>
      </main>
