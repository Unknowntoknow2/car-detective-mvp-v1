  ...
  const features = [
    {
      ...
      description:
        "Complete vehicle history with accident records, service history, and title verification",
      metric: "$44 Value",
      color: "blue",
    },
    {
      ...
      description:
        "Upload up to 5 photos for AI to analyze condition, damage, and wear patterns",
      metric: "+15% Accuracy",
      color: "green",
    },
    {
    ...
    },
    {
      ...
      description:
        "See average prices on Facebook, Craigslist, and other platforms in your area",
    ...
    },
    {
      ...
      description:
        "Predictive analysis of your vehicle's value over the next year with optimal selling time",
    ...
    },
    {
      ...
      description:
        "See exactly how much each option and feature adds to your vehicle's worth",
    ...
    },
    {
      ...
      description:
        "Location-adjusted valuation based on supply and demand in your specific region",
    ...
    },
    {
      ...
      description:
        "Comprehensive, shareable report with all insights and data in a professional format",
      ...
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-16 space-y-4">
          ...
          <p className="text-lg text-slate-600 max-w-3xl mx-auto">
            Our premium valuation service combines multiple data sources, AI
            analysis, and market intelligence to deliver the most accurate and
            comprehensive vehicle valuation available.
          </p>
        </div>
