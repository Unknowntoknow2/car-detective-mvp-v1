...
export function NhtsaRecalls(
  { make, model, year, className }: NhtsaRecallsProps,
) {
      ...
      <CardContent>
        ...
        <div className="mt-4 bg-amber-50 p-3 rounded-md border border-amber-200 text-xs">
          ...
          <div className="text-amber-600">
            Open safety recalls can reduce a vehicle's value by approximately 2%
            per recall. This vehicle has {data.length}{" "}
            open recall(s), potentially affecting its value by around{" "}
