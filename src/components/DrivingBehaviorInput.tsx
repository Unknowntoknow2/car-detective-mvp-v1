...
export function DrivingBehaviorInput(
  { value, onChange }: DrivingBehaviorInputProps,
) {
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="text-sm">
                ...
                <p className="text-muted-foreground mt-1">
                  Conservative drivers typically experience less wear and tear
                  on vehicle components like brakes and transmission. This can
                  positively impact your vehicle's value by 2-3% compared to
