              ...
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Includes 100 vehicle uploads per month
                  </p>
                </div>
                <div className="mt-4 md:mt-0 text-right">
                  <p className="text-2xl font-bold">
                    $99<span className="text-sm font-normal text-muted-foreground">
                      /month
                    </span>
                  </p>
                  <p className="text-sm text-muted-foreground">
                    Renews on June 1, 2023
                  </p>
                </div>
              </div>
              <div className="flex flex-col sm:flex-row gap-3">
                <Button variant="default" className="sm:flex-1">
                  Upgrade Plan
                </Button>
                <Button
                  variant="outline"
                  className="sm:flex-1 text-muted-foreground"
                >
                  Cancel Subscription
                </Button>
              </div>
                ...
                >
                  ...
                  <CardContent>
                    <p className="text-sm mb-4">
                      {typeof plan.uploads === "number"
                        ? `${plan.uploads} vehicle uploads per month`
                        : plan.uploads}
                    </p>
