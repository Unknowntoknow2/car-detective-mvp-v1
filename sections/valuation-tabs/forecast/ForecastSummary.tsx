      ...
      <Card className={`${trendBgClass} border ${trendBorderClass}`}>
        <CardContent className="pt-6 px-6 pb-6">
          <div className="flex items-start gap-3">
            <div
              className={`p-2 rounded-full ${trendBgClass} ${trendColorClass}`}
            >
              <TrendIcon className="h-6 w-6" />
            </div>
            <div>
              <h4 className="text-sm text-slate-600 font-medium mb-1">
                12-Month Trend
              </h4>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <div className="flex items-center">
                ...
                <span className={`ml-3 font-bold ${confidenceColor}`}>
                  {confidenceText}
                </span>
              </div>
              <p className="text-xs text-slate-500 mt-1">
