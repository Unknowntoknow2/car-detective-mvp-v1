import {
  ValuationPipelineReducerAction,
  ...
  steps: [
    {
      ...
      description:
        "Identify your vehicle using VIN, license plate, or manual entry",
      isCompleted: false,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      title: "Photos",
      description:
        "Upload photos of your vehicle for a more accurate valuation",
      isCompleted: false,
      isActive: false,
    },
    {
