...
export function drawCommentarySection(
  ...
  const { margin, width, headingFontSize, normalFontSize, smallFontSize } =
    constants;
  ...
  yPos -= 10;
  const commentaryText = explanation ||
    "This valuation explanation is currently unavailable. Please contact support.";
