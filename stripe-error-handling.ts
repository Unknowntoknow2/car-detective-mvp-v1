...
export function getStripeErrorDetails(error: any): StripeErrorDetails {
  ...
  if (
    ...
    errorMessage.includes("card") || errorMessage.includes("payment method")
  ) {
    return errorMessages.card_error;
  } else if (
    errorMessage.includes("invalid") || errorMessage.includes("parameter")
  ) {
    ...
    errorMessage.includes("validate") || errorMessage.includes("validation")
  ) {
    return errorMessages.validation_error;
  } else if (
    errorMessage.includes("session") && errorMessage.includes("create")
  ) {
