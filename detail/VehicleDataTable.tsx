...
export function VehicleDataTable(
  { vehicleInfo, manualValuation }: VehicleDataTableProps,
) {
  ...
  const dataRows = [
    ...
    {
      label: "Condition",
      value: formatValue("condition", mergedData.condition),
    },
    ...
    {
      label: "Transmission",
      value: formatValue("transmission", mergedData.transmission),
    },
